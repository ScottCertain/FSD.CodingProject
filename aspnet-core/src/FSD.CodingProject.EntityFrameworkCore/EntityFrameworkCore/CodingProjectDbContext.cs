...
public class CodingProjectDbContext :
    AbpDbContext<CodingProjectDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public CodingProjectDbContext(DbContextOptions<CodingProjectDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(CodingProjectConsts.DbTablePrefix + "YourEntities", CodingProjectConsts.DbSchema);
